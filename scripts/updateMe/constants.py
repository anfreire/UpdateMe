class GLOBAL:
    ARCHIVE_DIR = "/home/anfreire/Documents/Projects/updateMe/scripts"
...
class PREFIX:
    OK: str = f"[  {COLORS.GREEN}OK{COLORS.RESET}  ]"
    FAIL: str = f"[ {COLORS.RED}FAIL{COLORS.RESET} ]"
    INFO: str = f"[ {COLORS.BLUE}INFO{COLORS.RESET} ]"
    WARN: str = f"[ {COLORS.YELLOW}WARN{COLORS.RESET} ]"
