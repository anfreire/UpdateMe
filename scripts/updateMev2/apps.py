...
from providers.FiveModRu import FiveModRu
...
#####################################################################################
# PARTYPAL
def partypal(index: Index):
	# 5ModRu
	def fivemodru():
		mod = FiveModRu("razvlecheniya", "20402-partypal-drinking-game-321-mod-polnaja-versija")
		return mod.get_apk("PartyPal", "5Mod")
	
	app = AppBase("PartyPal", {"5Mod": fivemodru})
	app.update_downloaded("5Mod", fivemodru, index)
